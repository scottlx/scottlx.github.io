...
![bitcoin数据结构1](D:\Users\linxun2\Desktop\bitcoin数据结构1.png)
...
![bitcoin数据结构2](D:\Users\linxun2\Desktop\bitcoin数据结构2.png)
...
![merkel_tree](D:\Users\linxun2\Desktop\merkel_tree.png)
...
BTC的数量： $$ 210000*50+210000*25+\dots\=210000*50*(1+\frac12+\frac14+\dots)=21000000 $$ 挖矿求解过程没有意义，但是Bitcoin is secured by mining：当大部分算力掌握在诚实节点上的时候就是安全的（用算力投票）
